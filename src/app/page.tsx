...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-start min-h-[80vh] px-4 pt-12">
      ...
      >
        Kplor can see, talk, listen and create adaptive video content
      </motion.p>
      ...
      <section className="w-full flex flex-row items-center justify-center mt-32 mb-16">
        {/* Left: Our Partners Text */}
        <div className="hidden md:flex flex-col items-end pr-12 min-w-[220px]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <div className="w-full max-w-5xl overflow-visible scale-110">
            <Carousel />
          </div>
        </div>
      </section>
