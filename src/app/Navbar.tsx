...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className={`flex-col md:flex-row md:flex items-center gap-6 md:gap-8 text-base font-semibold ${aboutMenuOpen ? 'flex' : 'hidden'} md:flex bg-[#032859] md:bg-transparent absolute md:static top-full left-0 w-full md:w-auto p-4 md:p-0 z-40 md:mx-auto`}> 
